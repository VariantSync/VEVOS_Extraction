...
docker run --rm --volumes-from variability-extraction-linux --user "$(id -u)" --workdir="/home/$(id -u)" -v "$(pwd)/extraction-results/linux":data ubuntu cp -rf /home/user/extraction-results ~/data || exit
